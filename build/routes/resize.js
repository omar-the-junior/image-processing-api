...
resize.get('/resize', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let response = yield (0, createFormResponse_1.default)(imageName, Number(width), Number(height));
        if (imageName) {
            response += yield resizeImageFunction(imageName, Number(width), Number(height));
        }
